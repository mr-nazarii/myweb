      ...
      <div className="project-wrapper">
        ...
        <div className="project-main-img-wrapper2">
          <p className="project-descdescription-text">
            ...
            and technology. Navigating uncharted terrains of innovation
            together, crafting designs and technology solutions that pave the
            way for the future.
          </p>
          <div className="project-main-img-wrapper1">
            <div className="project-main-img">
        ...
        <div className="project-main-button">
          <Link className="project__link2" href={`/Services`}>
            More Works
            <svg
              width="33"
              height="10"
